...
{
    /// <summary>
    /// CSIS 4050 Group Project Team 7
    /// </summary>
    public partial class ElectronicShopMainForm : Form
    {
        ...
        private void ElectronicShopMainForm_Load()
        {
            ...
            InitializeListBoxCategory();
            AddOrUpdateInventory addOrUpdateInventory = new AddOrUpdateInventory();
            buttonAddUpdateInventory.Click += (s, e) => AddUpdateForm<Inventory>(dataGridViewInventory, addOrUpdateInventory);
        ...
        #region Common Method for all the tab pages
        ...
        /// <summary>
        /// Show up the Add or Update Child Form
        /// </summary>
        ...
        #region Adminstration Tab Page

        /// <summary>
        /// Delete the selected items in datagridview
        /// Sum the total price based on the actual data cell
        /// </summary>
        ...
        /// <summary>
        /// Button order to add the selected items to the Sales Order page
        /// Updating dataGridViewOrder after added new order
        /// Clear all the fields to get the new order
        /// </summary>
        ...
        /// <summary>
        /// Add selected item from listboxes to the datagridview
        /// Calculate sub total for the selected item based on unit price and quantity
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Display datagridview for selected items
        /// We got 5 columns to show the detail selected items
        /// </summary>
        ...
        /// <summary>
        ///  Initilize the Version List Box 
        /// User can select the version from the Inventory
        /// </summary>
        ...
        /// <summary>
        ///  Initilize the Current List Box 
        /// User can select the current from the Inventory
        /// </summary>
        /// <param name="inventories"></param>
        ...
        /// <summary>
        ///  Initilize the Voltage List Box 
        /// User can select the voltage from the Inventory
        /// </summary>
        /// <param name="inventories"></param>
        ...
        /// <summary>
        /// Initilize the Type List Box 
        /// User can select the type from the Inventory
        /// </summary>
        /// <param name="inventories"></param>
        ...
        /// <summary>
        /// Initilize the Category List Box 
        ...
        #region Sales Order Tab Page

        /// <summary>
        /// SelectionMode for listbox is multi selection in SalesOrder Tab.
        /// </summary>
        ...
        /// <summary>
        /// This method is used to display all orders in sales order's datagridview
        /// </summary>
        ...
        /// <summary>
        /// This method is used to drop all orders in Sales order tab.
        /// </summary>
        ...
        /// <summary>
        /// This method is used to drop orders in Sales order tab.
        /// </summary>
        ...
        /// <summary>
        /// This method is used to show all orders in Sales order Tab.
        /// </summary>
        ...
        #region Database backup Tab Page
