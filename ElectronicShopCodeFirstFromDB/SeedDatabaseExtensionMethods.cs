...
namespace ElectronicShopCodeFirstFromDB
{
    ...
    {
        /// <summary>
        /// Method to seed the customer, inventory, category, order and order details data into SQL server.
        /// </summary>
        ...
        /// <summary>
        /// Method to save the data from entity framework to XML files
        /// </summary>
        /// <param name="context"></param>
        ...
        /// <summary>
        ///  Method to read the xml files and put the data into entity framework.
        /// </summary>
        /// <param name="context"></param>
